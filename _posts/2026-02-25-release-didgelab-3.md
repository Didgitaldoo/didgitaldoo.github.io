...
* **Extensive Documentation**: [Completely overhauled](https://github.com/Didgitaldoo/didge-lab/blob/main/doc/README.md).
* **Modular Architecture**: The source code has been reorganized for better extensibility and future-proofing.
* **Advanced acoustic simulation**: Added [1D Finite Element Method]((https://github.com/Didgitaldoo/didge-lab/blob/main/doc/simulation_methods/acoustical_simulation/1d_fem.md)) alongside the existing [transmission line model](https://github.com/Didgitaldoo/didge-lab/blob/main/doc/simulation_methods/acoustical_simulation/transmission_line_model.md).
